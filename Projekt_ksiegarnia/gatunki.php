  ...
  <h2>Powieści fantazy</h2>
    <div class="book-grid2">
      ...
      <div class="book2">
        ...
        <h2>Harry Potter i Kamień Filozoficzny</h2>
      ...
      <h2>Powieści fikcyjne</h2>
      <div class="book2">
        <img src="book5.jpg" alt="Lalka">
        <h2>Lalka</h2>
        <p>Historia zamożnego kupca warszawskiego Stanisława Wokulskiego i jego miłości do pięknej, lecz zubożałej arystokratki Izabeli Łęckiej. Temu niszczącemu uczuciu Wokulski podporządkowuje swoje interesy, wchodzi w niekorzystne dla siebie układy z rodzinami arystokratycznymi, chcąc w pośredni sposób pomóc ukochanej.</p>
